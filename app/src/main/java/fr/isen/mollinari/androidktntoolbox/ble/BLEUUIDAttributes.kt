...
enum class BLEUUIDAttributes(val uuid: String, val title: String) {
    ...
    CUSTOM_CHARACTERISTIC("466c5678-f593-11e8-8eb2-f2801f1b9fd1", "Characteristique spécifique"),
    CUSTOM_CHARACTERISTIC_2("466c9abc-f593-11e8-8eb2-f2801f1b9fd1", "Characteristique spécifique"),
